...
let Weather = (function () {  
    ...
    var testFunc = Symbol('testFunc func');
    var nameKey = Symbol('nameKey');
    ...
    class Weather {
        constructor(weatherURL, place='Shenzhen,China', apiKey) {   
            ...
            this.url = weatherURL; 
            this.place = place;
            this.fetchURL = this.url + this.place + '&appid=' + privateProps.get(this).key;
            this.iconURL='';
              ...
              this[nameKey] = 'secret name here. do not expose';

        } // constructor

        // prototype function
        test = () => {
            console.log('prototype func', 'test');
              privateProps.get(this).test(); // scope privateProps
        }
          ...
          // prototype functions
           fetchWeatherData = () => {
            fetch(this.fetchURL)  
            .then(resp => resp.json())
            .then(data => privateProps.get(this).updateWeatherUI(data))
            .catch(function() {}); 
          }
    }  
    return Weather;  
